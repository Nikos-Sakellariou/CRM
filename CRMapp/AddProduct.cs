...
namespace CRMapp
{
    public partial class AddProduct : UserControl
    {
        ...
        private void AddBtn_Click(object sender, EventArgs e)
        {
            ...
            if (DescrTxt.Text == "" || LongDescrTxt.Text == "" || QuantTxt.Text == "" || PriceTxt.Text == "" || DiscTxt.Text == "" || UnitTxt.Text == "" || ProfitPercTxt.Text == "")
            {
                ...
                using (SqlConnection sqlcon = new SqlConnection(con.ConnectionString))
                {
                    try
                    {
                        ...
                        else
                        {
                            ...
                            try
                            {
                                InsCmd1.CommandText = "insert into Products(Id, Description, LongDescr, Manufacture, Unit, ProfitPerc, SupplierDescr) values((select dbo.nvl(Max(Id)+1,10000) from dbo.Products), @descr, @longd, @manuf, @unit, @prof, @supdescr)";
