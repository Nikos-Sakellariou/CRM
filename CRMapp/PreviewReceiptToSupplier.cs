...
namespace CRMapp
{
    public partial class PreviewReceiptToSupplier : Form
    {
        SqlConnectionStringBuilder con = new SqlConnectionStringBuilder();
        Checks chk = new Checks();

        public PreviewReceiptToSupplier(string Id)
        {
            GC.Collect();
            ...
            using (SqlConnection sqlcon = new SqlConnection(con.ConnectionString))
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        string query = "select SupplierId,Name,Afm,ReceiptId,ReceiptSeries,ReceiptDate,ReceiptPrice, ReceiptCash from MySupplierReceipt a, Suppliers b where a.SupplierId=b.Id and a.Id=@id";
                        ...
                        string query2 = "select ValueDocId,ValueDocDate,ValueDocPrice,ValueDocIssuer from ReceiptValueDocs where ReceiptKind=3 and ReceiptId=@id";
