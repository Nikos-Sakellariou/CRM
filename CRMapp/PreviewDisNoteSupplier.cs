...
namespace CRMapp
{
    public partial class PreviewDisNoteSupplier : Form
    {
        SqlConnectionStringBuilder con = new SqlConnectionStringBuilder();
        Checks chk = new Checks();

        public PreviewDisNoteSupplier(string Id)
        {
            GC.Collect();
        ...
        private void GetData(string Id)
        {
            using (SqlConnection sqlcon = new SqlConnection(con.ConnectionString))
            {
                try
                {
                    ...
                    try
                    {
                        string query = "select SupplierId,Name,Afm,DisNoteId,DisNoteSeries,DisNoteDate from SupplierDisNote a, Suppliers b where a.SupplierId=b.Id and a.Id=@id";
                        ...
                        string query2 = "select ProductId,SupplierDescr,ProductQuant,LongDescr from SupplierDisNoteProducts a, Products b where a.ProductId=b.Id and a.SupplierDisNoteId=@id";
