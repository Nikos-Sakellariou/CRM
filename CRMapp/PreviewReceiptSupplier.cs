...
namespace CRMapp
{
    public partial class PreviewReceiptSupplier : Form
    {
        SqlConnectionStringBuilder con = new SqlConnectionStringBuilder();
        Checks chk = new Checks();

        public PreviewReceiptSupplier(string Id)
        {
            GC.Collect();
            ...
            using (SqlConnection sqlcon = new SqlConnection(con.ConnectionString))
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        string query = "select SupplierId,Name,Afm,ReceiptId,ReceiptSeries,ReceiptDate,ReceiptPrice,ReceiptCash from SupplierReceipt a, Suppliers b where a.SupplierId=b.Id and a.Id=@id";
                        ...
                        string query2 = "select ValueDocId,ValueDocDate,ValueDocPrice,ValueDocIssuer from ReceiptValueDocs where ReceiptKind=2 and ReceiptId=@id";
