...
namespace CRMapp
{
    public partial class PreviewDisNoteCustomer : Form
    {
        SqlConnectionStringBuilder con = new SqlConnectionStringBuilder();
        Checks chk = new Checks();

        public PreviewDisNoteCustomer(string Id)
        {
            GC.Collect();
        ...
        private void GetData(string Id)
        {
            using (SqlConnection sqlcon = new SqlConnection(con.ConnectionString))
            {
                try
                {
                    ...
                    try
                    {
                        string query = "select CustomerId,Name,Afm,DisNoteId,DisNoteSeries,DisNoteDate from CustomerDisNote a, Customers b where a.CustomerId=b.Id and a.Id=@id";
                        ...
                        string query2 = "select ProductId,Description,ProductQuant,LongDescr from CustomerDisNoteProducts a, Products b where a.ProductId=b.Id and a.CustomerDisNoteId=@id";
